# =============================================================================
# We See You (WSY) - Scalable Enterprise Multi-AZ Architecture Deployment
# =============================================================================
# NOTE: This directory contains the complete, highly available, scalable enterprise 
# architecture (VPC, ALB, ECS Fargate, RDS PostgreSQL, CloudFront CDN, Route53, 
# Lambda ETL, and CloudWatch Dashboard).
# Preserved for portfolio demonstration and future high-traffic production scaling.
# =============================================================================
...
# -----------------------------------------------------------------------------
# 10. AWS Lambda ETL Ingestion Worker Module (Scheduled Weekly Sync)
# -----------------------------------------------------------------------------
module "lambda_etl" {
...
# -----------------------------------------------------------------------------
# 11. CloudWatch Monitoring & Operational Dashboard Module
# -----------------------------------------------------------------------------
module "monitoring" {
