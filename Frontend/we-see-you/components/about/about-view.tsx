  ...
  return (
    <div className={styles.container}>
      <header className={styles.header}>
        ...
        <p>
          An open political transparency platform providing real-time data on U.S. politicians,
          Congressional committees, campaign finance records, and legislation across national, state, and local government.
        </p>
      </header>
